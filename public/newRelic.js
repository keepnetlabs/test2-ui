function createNewRelic() {
  ...
  window.NREUM || (NREUM = {})
  NREUM.loader_config = {
    accountID: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.accountID,
    trustKey: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.trustKey,
    agentID: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.agentID,
    licenseKey: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.licenseKey,
    applicationID: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.applicationID
  }
  NREUM.info = {
    beacon: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.beacon,
    errorBeacon: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.errorBeacon,
    licenseKey: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.licenseKey,
    applicationID: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.applicationID,
    sa: APP_CONFIG.VUE_APP_NEW_RELIC_VALUE.sa
  }
