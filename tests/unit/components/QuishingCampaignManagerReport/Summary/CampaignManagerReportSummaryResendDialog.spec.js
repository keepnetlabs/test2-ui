...
import CampaignManagerReportSummaryResendDialog from '@/components/QuishingCampaignManagerReport/Summary/CampaignManagerReportSummaryResendDialog.vue'

describe('QuishingCampaignManagerReport Summary CampaignManagerReportSummaryResendDialog.vue', () => {
  ...
  describe('handleConfirm', () => {
    it('emits on-confirm with types', () => {
      ...
      expect(wrapper.emitted('on-confirm')[0]).toEqual([[1, 2]])
    })
  })
})
