...
import DeleteServiceModal from '@/components/Settings/DnsServices/DeleteServiceModal.vue'

describe('Settings DeleteServiceModal.vue', () => {
  ...
  describe('handleDelete', () => {
    it('emits handleDelete with selectedDnsService and calls closeModal', () => {
      const selectedDnsService = { resourceId: '1', dnsServiceProviderName: 'Test' }
