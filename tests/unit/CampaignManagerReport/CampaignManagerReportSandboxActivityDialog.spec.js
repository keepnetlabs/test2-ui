...
import CampaignManagerReportSandboxActivityDialog from '@/components/CampaignManagerReport/CampaignManagerReportSandboxActivityDialog'

jest.mock('@/api/phishingsimulator', () => ({
  updateSandboxActivity: jest.fn().mockResolvedValue({ data: {} })
}))

describe('CampaignManagerReportSandboxActivityDialog.vue', () => {
  ...
  const mountComponent = (propsData = {}, options = {}) => {
    return shallowMount(CampaignManagerReportSandboxActivityDialog, {
      localVue,
  ...
  describe('Component Rendering', () => {
    ...
    it('should have correct component name', () => {
      const wrapper = mountComponent()
      expect(wrapper.vm.$options.name).toBe('CampaignManagerReportSandboxActivityDialog')
    })
  ...
  describe('Dialog Content', () => {
    it('should display bot activity confirmation message', () => {
      const wrapper = mountComponent()
      expect(wrapper.text()).toContain("Do you want to mark this user as a 'Bot Activity'")
    })

    it('should reference taking back system decision', () => {
      const wrapper = mountComponent()
      expect(wrapper.text()).toContain('taking back the system decision')
    })
  ...
  describe('Edge Cases', () => {
    it('should handle missing selectedRow gracefully', () => {
      const wrapper = mountComponent({ selectedRow: {} })
      expect(wrapper.vm.selectedRow).toBeDefined()
    })

    it('should handle undefined searchType gracefully', () => {
      const wrapper = mountComponent({ searchType: undefined })
      expect(wrapper.vm.searchType).toBe('opened')
    })
  })
  ...
  describe('Integration Scenarios', () => {
    ...
    it('complete workflow: render and confirm bot activity marking', async () => {
      const wrapper = mountComponent({
        status: true,
        selectedRow: { resourceId: '123', name: 'Test User' },
        searchType: 'clicked'
      ...
      expect(wrapper.text()).toContain("Do you want to mark this user as a 'Bot Activity'")
      expect(wrapper.vm.selectedRow.resourceId).toBe('123')
    })
  })
