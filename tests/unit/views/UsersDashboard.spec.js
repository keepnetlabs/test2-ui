...
describe('UsersDashboard.vue', () => {
  ...
  it('created dispatches initialization and dashboard fetch actions', () => {
    ...
    expect(dispatch).toHaveBeenCalledWith('usersDashboard/fetchTopDepartmentPerformance')
    expect(dispatch).toHaveBeenCalledWith('usersDashboard/fetchTopDepartmentUserPerformance')
