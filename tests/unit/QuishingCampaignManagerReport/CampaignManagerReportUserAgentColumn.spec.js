...
describe('QuishingCampaignManagerReport/CampaignManagerReportUserAgentColumn.vue', () => {
  ...
  it('renders user agent text from scope row', () => {
    const wrapper = mountComponent({ row: { userAgent: 'Quishing-Agent', sandBoxType: 1 } })
    expect(wrapper.text()).toContain('Quishing-Agent')
  })
})
