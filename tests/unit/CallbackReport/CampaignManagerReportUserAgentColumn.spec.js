...
import CampaignManagerReportUserAgentColumn from '@/components/CallbackReport/CampaignManagerReportUserAgentColumn.vue'

describe('CallbackReport/CampaignManagerReportUserAgentColumn.vue', () => {
  ...
  it('renders user agent text from scope row', () => {
    const wrapper = mountComponent({ row: { userAgent: 'Callback-Agent', sandBoxType: 1 } })
    expect(wrapper.text()).toContain('Callback-Agent')
  })
})
