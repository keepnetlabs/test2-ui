<template>
  <AppDialog
    ...
    title="Mark User as Human Activity"
    :status="status"
  ...
  >
    <template #app-dialog-body>
      <div>
        <div>
          Do you want to mark this user as a 'Human Activity' by changing the system decision?
        </div>
...
export default {
  name: 'CampaignManagerReportHumanActivityDialog',
