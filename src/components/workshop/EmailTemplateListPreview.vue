          ...
          <multipane class="vertical-panes" layout="vertical">
            ...
            >
              ...
              <div
                ...
                class="pl-5 pt-5"
              >
                Go to Quishing Simulator > Quishing Scenarios > Quishing Templates to
                create a new individual printout template
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      bodyData:
        this.defaultBodyData || getDefaultEmailTemplatePayload(this.categoryResourceId),
