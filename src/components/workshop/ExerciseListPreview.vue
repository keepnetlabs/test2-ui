        ...
        <v-list-item class="k-dialog__header" :class="['k-dialog__header-max-height']">
          ...
          <div>
            <v-list-item-title class="k-dialog__title"
              >Training Exercise List Preview</v-list-item-title
            >
          </div>
        </v-list-item>
        <div class="workshop-title">Remediation Training</div>
        <div class="workshop-subtitle">
          Select a training piece to show automatically when users fal for phishing
        </div>
        <div class="workshop-content">
          ...
          <multipane class="vertical-panes" layout="vertical">
            ...
            <div class="pane" :style="{ flexGrow: 1 }">
              <div class="template-preview" v-if="!!exerciseContent">
                <videoPlayer
...
export default {
  name: 'ExerciseListPreview',
  props: {},
  components: { Multipane, MultipaneResizer, videoPlayer },
  data() {
    return {
      search: null,
      listData: [],
    ...
    setSelectedTemplate(item, index) {
      ...
      getSelectedEmailPreview(item.resourceId)
        .then((response) => {
          ...
          this.exerciseContent = response.data.data.initialBody
        })
        .finally(() => {
