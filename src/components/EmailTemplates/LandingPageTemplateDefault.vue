<template>
  <table style="margin-top: 24px; border-spacing: 0; border: none !important; width: 100%;">
    <tbody>
      ...
      <tr style="font-family: 'Open Sans', sans-serif; margin-left: 24px;">
        <td style="width: 65%; padding-left: 24px;">
          <h1
            style="
              font-style: normal;
              font-weight: normal;
            ...
            "
          >
            Let’s design a landing page template
          </h1>
          <h2
            style="
              margin-top: 16px;
        ...
        <td style="width: 35%;">
          ...
          >
            <p
              ...
              "
            >
              Drag & drop layouts, blocks, images and text
            </p>
            <div style="margin: 0 auto; position: relative; width: 111px;">
              <div
                style="
                  height: 111px;
                  margin-left: 22px;
                  ...
                  border: 1px dashed #40abec;
                "
              ></div>
              <img
                style="position: absolute; left: -26px; top: 45px;"
                ...
                alt="drop-layout-logo"
              />
              <img
                style="position: absolute; left: -12px;"
                alt="drop-layout-logo-cursor"
      ...
      <tr style="margin-left: 24px;">
        <td style="width: 65%; padding-left: 24px;">
          ...
          <h2
            ...
            "
          >
            Use shortcodes for every automatized text and link you need
          </h2>
          <p
            style="
              font-family: 'Open Sans', sans-serif;
            ...
            "
          >
            Use shortcodes to set links between pages, define user names, email addresses, URLs,
            training pieces, dates and many more properties
          </p>
        </td>
        <td style="width: 35%; padding-right: 24px;">
          <div
            style="
              font-family: 'Open Sans', sans-serif;
              background-color: #f1f8fe;
      ...
      <tr style="margin-left: 24px;">
        <td style="width: 35%; padding-left: 24px;">
          <div
            style="
              font-family: 'Open Sans', sans-serif;
              background-color: #f1f8fe;
            ...
            "
          >
            <div style="height: 100%; position: relative; padding: 45px 50px;">
              <p
                style="
                  font-weight: 600;
                  font-size: 20px;
              ...
              <form type="POST" style="margin-bottom: 16px;">
                <input
                  style="
                    display: block;
                    margin-top: 16px;
        ...
        <td style="width: 65%; padding-right: 24px;">
          <h1
            style="
              font-family: 'Open Sans', sans-serif;
              font-style: normal;
            ...
            "
          >
            Create forms for realistic phishing simulations
          </h1>
          <h2
            style="
              font-family: 'Open Sans', sans-serif;
            ...
            "
          >
            Use input fields and submit buttons to see who takes the bait!
          </h2>
          <p
            style="
              font-family: 'Open Sans', sans-serif;
            ...
            "
          >
            Drag and drop form elements, labels, placeholders and give them style
          </p>
        </td>
      </tr>
...
<script>
export default {
  name: 'LandingPageTemplateDefault',
  props: {
    emailTemplateLogo: {
      type: String
    }
