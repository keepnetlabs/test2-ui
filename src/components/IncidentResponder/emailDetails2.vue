    ...
    <div class="email-details-content">
      <div class="ed-header">
          ...
          >
            <template v-slot:actions mandatory="true">
              <v-btn
                ...
                :id="'email-details-collapse' + post.CommunityPostId"
                :key="'email-details-collapse' + post.CommunityPostId"
                outlined
                rounded
                medium
                color="blue"
              ...
              <v-btn
                ...
                :id="'email-details-details' + post.CommunityPostId"
                :key="'email-details-details' + post.CommunityPostId"
                outlined
                rounded
                medium
                color="blue"
        ...
        <v-menu v-if="post.IsPreview" offset-y transition="scale-transition">
          <template v-slot:activator="{ on }">
            <v-btn :id="'email-details-dots' + post.CommunityPostId" icon color="blue" v-on="on">
      ...
      <div class="ed-user-comp">
        <div :id="'post-details' + post.CommunityPostId" class="ed-user-comp-detail">
          by
      ...
      <div class="ed-body">
        <v-clamp
          :id="'email-details-description-body' + post.CommunityPostId"
      ...
      <div :id="'email-details-footer' + post.CommunityPostId" class="ed-footer d-flex row wrap">
        <div class="ed-like mt-1">
          <v-btn
            :id="'email-details-like' + post.CommunityPostId"
            v-if="!post.UserLiked"
            disabled
            text
            x-small
          ...
          <v-btn
            :id="'email-details-unlike' + post.CommunityPostId"
          ...
          <span class="ed-action-counter">{{ post.LikeCount }}</span>
        </div>
        <div class="ed-message mt-1">
          <v-btn
            :id="'email-details-reply' + post.CommunityPostId"
            text
            x-small
            icon
            color="grey"
    ...
    >
      ...
      <v-tabs-items v-show="postDetail.Data && postDetail.IsSuccess" v-model="tab">
        ...
        <v-tab-item>
          ...
          <div id="email-details-body" class="preview-body">
            <k-shadow-frame
              id="sframe"
            ...
            >
              <div class="attachment-wrapper">
                <div
                  ...
                  :id="'email-details-attachments-' + att.Id"
                  :class="[
          ...
          <div class="preview-comments" :class="{ 'open-comments': commentOpened }">
            <div class="add-comment-row">
              <v-text-field
                :id="'email-details-comment-' + postDetail.Data.CommunityPostId"
                class="comment-input"
              ...
              />
              <v-btn
                :id="'email-details-send-comment' + postDetail.Data.CommunityPostId"
            ...
            <div
              ...
              "
              id="email-details-see-all-comments"
  ...
  methods: {
    ...
    getPostDetails(postId, ind, bool) {
      const postDetailObj = {
        ...
        communPostId: 'e6334b82-7752-45cd-bb57-a3a991504ae4'
      }
