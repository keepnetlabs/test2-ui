  ...
  <div class="campaign-manager-last-step">
        ...
        <template #body>
          <div class="campaign-manager-last-step__target-users-body pb-4">
            ...
            <AlertBox
              ...
              :icon-color="getNonPreferredLanguageUsersCount === 0 ? '#43A047' : '#2196f3'"
              :icon-name="
                getNonPreferredLanguageUsersCount === 0 ? 'mdi-check-circle' : 'mdi-alert-circle'
              "
    ...
    <div class="campaign-manager-last-step__email-template mt-4">
      <CampaignManagerSummaryCard
        ...
        icon="mdi-email"
        is-training
        :show-body-detail.sync="showEmailTemplatePreviewDialog"
...
export default {
  ...
  computed: {
    ...
    getEmailTemplateTitle() {
      ...
      const baseTitle =
        this.type === SCENARIO_TYPES.PHISHING ? 'Email Template:' : 'Individual printout:'
      return `${baseTitle} ${templateName}`
    },
    getLandingPageTitle() {
    ...
    getPreferredLanguageAlertBoxClass() {
      const classes = ['mt-4']
      if (this.getNonPreferredLanguageUsersCount === 0) {
    ...
    getNonPreferredLanguageUsersCount() {
    ...
    getPreferredLanguageText() {
      ...
      if (languageCounts.size === 0) {
        ...
        const languageText = Array.from(languageCounts.entries())
