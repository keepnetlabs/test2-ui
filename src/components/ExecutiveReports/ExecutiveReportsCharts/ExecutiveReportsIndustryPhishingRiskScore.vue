  ...
  <WidgetLoading :loading="isLoading">
    <template #skeleton-content>
      <ExecutiveWidgetContainer
        class="executive-report-phishing-risk-score-container"
      >
        ...
        <ExecutiveWidgetBody>
          <template v-if="!isEmpty">
            ...
            <span
              ...
              >This chart shows the organization's phishing risk score per
              campaign against the industry benchmark.
            </span>
          </template>
          <div
            v-else
  ...
  methods: {
    ...
    setChartData(data) {
      ...
      const totalUserActions = data[0]?.widgetDatas.reduce((acc, item) => {
        const temporalAcc =
          item.dataObject.totalReportedCount + item.dataObject.totalMetrics;
            ...
            generateLabels(chart = {}) {
              ...
              return data.datasets.map((item, index) => {
                if (item.label.includes("Industry Average")) {
                  ...
                  return {
                    text: Array.from(
                      label + label.substring(0, label.length / 1.4)
                    )
                      .fill("")
                      .join(" "),
                    ...
                    datasetIndex: index,
                    textParts: [
                      splittedLabel[0] + " " + splittedLabel[1],
                      splittedLabel[2]
                    ]
                  };
                }
        ...
        tooltips: {
          ...
          custom: function (tooltipModel) {
            let tooltipEl = document.getElementById(
              "chartjs-tooltip-phishing-risk-score"
            );
            ...
            if (!tooltipEl) {
              ...
              tooltipEl.innerHTML =
                '<div class="tooltip-content" style="width:240px;"></div>';
            ...
            let tooltipWidth =
              tooltipEl.offsetWidth > 300 ? 250 : tooltipEl.offsetWidth || 240;
            ...
            if (tooltipModel.body && this._chart && this._chart.data.datasets) {
              ...
              if (phishingType === "Phishing") {
                ...
                detailsObj["Risky Actions"] =
                  totalCalledCount + totalEnteredCount;
              }
        ...
        plugins: {
          datalabels: {
            ...
            formatter: function (value, context) {
              if (
                context.dataset.label.includes("Phishing Risk Score") &&
                value.y > 0
              ) {
                return value.y + "%";
              }
