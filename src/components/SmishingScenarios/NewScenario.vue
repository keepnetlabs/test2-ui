      ...
      <v-stepper
        ...
        <v-stepper-header class="k-stepper__header">
          <v-stepper-step
            ...
            :complete="step > 1"
            :step="1">Scenario Info</v-stepper-step>
          <v-divider class="k-stepper__divider" />
          <v-stepper-step
            class="k-stepper__step"
            :complete="step > 2"
            :step="2">Text Message</v-stepper-step>
          <v-divider class="k-stepper__divider" />
          ...
          <v-stepper-step
            ...
            :step="isAttachmentBasedScenario ? 10 : 3">Landing Page</v-stepper-step>
          <v-divider class="k-stepper__divider" />
          <v-stepper-step
            class="k-stepper__step"
            :complete="isAttachmentBasedScenario ? step > 3 : step > 4"
            :step="isAttachmentBasedScenario ? 3 : 4">Summary</v-stepper-step>
        </v-stepper-header>
          ...
          <v-stepper-content
            ...
            <div class="phishing-scenario-info">
              <v-list-item>
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle
                    class="new-phishing-scenario__sub-title">Enter basic information about this scenario</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
              ...
              <v-form
                ...
                <form-group
                  title="Tags"
                  sub-title="Define tags for the scenario">
                  <InputTag
              ...
              <v-list-item style="margin-top: -10px;">
                <v-list-item-content>
                  <LandingPageListPreview
                    ...
                    @loading="isSubmitDisabled = $event"/></v-list-item-content>
              </v-list-item>
            </div>
          </v-stepper-content>
          <v-stepper-content
            ...
            <div class="email-settings">
              <v-list-item class="mb-8">
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle
                    class="new-phishing-scenario__sub-title">Preview what this scenario will look like</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
              <v-list-item>
                <v-list-item-content>
                        ...
                        <div
                          ...
                          <v-chip
                            ...
                            <v-icon
                              ...
                              color="#fff">mdi-web</v-icon>{{ textMessageTemplate && textMessageTemplate.languageShortCode }}
                          </v-chip>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="summary-header">
                      ...
                      <div>
                        <v-btn
                          ...
                          outlined
                          color="#2196f3"
                          @click="showTemplate2 = !showTemplate2">Preview
                          <v-icon
                            :color="'#2196f3'"
                            class="ml-2"
                            left
                          ...
                          <div class="d-flex justify-space-between">
                            ...
                            <div
                              ...
                              <v-chip
                                ...
                                <v-icon
                                  style="font-size: 18px;"
                                  color="#fff">mdi-web</v-icon>{{ landingPageTemplate && landingPageTemplate.languageShortCode }}
                              </v-chip>
                            </div>
                          </div>
                        </el-tab-pane>
