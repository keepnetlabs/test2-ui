          ...
          <el-tabs value="textMessage">
            <el-tab-pane id="textMessage" label="Text Message" name="textMessage">
              <div class="d-flex flex-column py-6">
                ...
                <span class="text-body-1">{{ getTextMessage }}</span>
              </div>
            </el-tab-pane>
          </el-tabs>
        </div>
...
// TODO: Change endpoints with correct ones
import {
...
export default {
  ...
  computed: {
    ...
    getTextMessage() {
      return (
        this.emailTemplateParams?.textMessage ||
  ...
  methods: {
    ...
    exportEmailTemplates({ exportTypes, reportAllPages, pageNumber, pageSize }) {
      exportTypes.map((exportType) => {
        ...
        // TODO: Change endpoint with correct one
