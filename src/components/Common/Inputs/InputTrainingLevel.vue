...
export default {
  ...
  props: {
    ...
    title: {
      type: String,
      default: "Training Level"
    },
    subTitle: {
      type: String,
      default: "Select the level of knowledge required for this training"
    },
    placeholder: {
      type: String,
  ...
  computed: {
    requiredRules() {
      return [(v) => Validations.required(v, labels.Required)];
    }
  }
};
</script>
