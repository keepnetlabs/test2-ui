    ...
    function (e, t, n) {
      ...
      var i = n(0),
        ...
        C = function (e, t) {
          ...
          var p = v(a[0]).parentNode,
            f = getComputedStyle ? getComputedStyle(p) : null,
            C = f ? f.flexDirection : null,
            O =
              m(t, 'sizes') ||
              a.map(function () {
                return 100 / a.length
            ...
            P = m(t, 'expandToMin', !1),
            j = m(t, 'gutterSize', 10),
            z = m(t, 'gutterAlign', 'center'),
            x = m(t, 'snapOffset', 30),
            k = m(t, 'dragInterval', 1),
            T = m(t, 'direction', 'horizontal'),
            L = m(t, 'cursor', 'horizontal' === T ? 'col-resize' : 'row-resize'),
            _ = m(t, 'gutter', y),
          ...
          function U(e) {
            var n,
              ...
              r = c[this.b]
            this.dragging &&
              ((n = A(e) - this.start + (this._b - this.dragOffset)),
          ...
          function V(e) {
            ...
            var n = 0,
              i = [],
              r = e.map(function (r, o) {
                var s = (t * r) / 100,
                  c = g(j, 0 === o, o === e.length - 1, z),
                  a = w[o] + c
          ...
          function $() {
            var e = c[this.a].element,
              n = c[this.b].element
            this.dragging && m(t, 'onDragEnd', h)(B()),
              (this.dragging = !1),
          ...
          function W(e) {
            if (!('button' in e) || 0 === e.button) {
              var n = c[this.a].element,
                i = c[this.b].element
              this.dragging || m(t, 'onDragStart', h)(B()),
                e.preventDefault(),
                (this.dragging = !0),
                (this.move = U.bind(this)),
                (this.stop = $.bind(this)),
                ...
                (this.gutter.style.cursor = L),
                (this.parent.style.cursor = L),
                (d.body.style.cursor = L),
                I.call(this),
                (this.dragOffset = A(e) - this.end)
            }
          }
          'horizontal' === T
            ? ((n = 'width'), (i = 'clientX'), (r = 'left'), (o = 'right'), (s = 'clientWidth'))
            : 'vertical' === T &&
              ((n = 'height'), (i = 'clientY'), (r = 'top'), (o = 'bottom'), (s = 'clientHeight')),
            (O = V(O))
          var F = []
          function N(e) {
            var t = e.i === F.length,
          ...
          return (
            (c = a.map(function (e, t) {
              var i,
                r = { element: v(e), size: O[t], minSize: w[t], i: t }
              if (
                t > 0 &&
                (((i = { a: t - 1, b: t, dragging: !1, direction: T, parent: p })._b = g(
                  j,
                  t - 1 == 0,
                  !1,
                  z
                )),
                (i._c = g(j, !1, t === a.length - 1, z)),
                'row-reverse' === C || 'column-reverse' === C)
              ) {
                var o = i.a
                ;(i.a = i.b), (i.b = o)
              }
              if (t > 0) {
                ...
                !(function (e, t, i) {
                  ...
                  (i._a = W.bind(i)),
                  s.addEventListener('mousedown', i._a),
                  s.addEventListener('touchstart', i._a),
                  p.insertBefore(s, r.element),
                  (i.gutter = s)
              }
              return (
                M(r.element, r.size, g(j, 0 === t, t === a.length - 1, z), t), t > 0 && F.push(i), r
              )
            })).forEach(function (e) {
        ...
        function e(t, n) {
          s()(this, e),
            ...
            (this.panelViews = n.appendTo
              ? this.$(n.appendTo)
              : this.findWithinEditor('.'.concat(this.pfx, 'pn-').concat(n.panelId))),
            (this.isShowing = !0)
        }
        return (
          a()(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                i &&
                  !this.opts.appendTo &&
                  i.set('appendContent', this.codePanel).trigger('change:appendContent'),
                  this.opts.appendTo && t(this.opts.appendTo).append(this.codePanel),
            ...
            },
            {
              ...
              value: function () {
                var e = this.editor,
                  t = this.component,
                  n = this.htmlCodeEditor.getContent().trim()
                if (n && n !== this.previousHtmlCode) {
                  ...
                  this.cssCodeEditor
                    ...
                    (n += '<style>'.concat(i, '</style>')),
                    e.select(t.replaceWith(n))
                }
              }
            },
            {
              ...
              value: function () {
                ...
                e &&
                  e !== this.previousCssCode &&
                  (this.parseRemove(e),
                  (this.previousCssCode = e),
                  this.editor.Components.addComponent('<style>'.concat(e, '</style>')))
              }
            },
            {
              ...
              value: function (e) {
                ...
                n.Parser.parseCss(e).forEach(function (e) {
                  ...
                  e.selectors.length &&
                    ...
                    e.selectorsAdd &&
                      e.selectorsAdd.split(', ').forEach(function (e) {
                        t.removeSelector(e, r, i, n)
                      })
                })
              }
