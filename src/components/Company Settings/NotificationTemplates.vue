...
export default {
      ...
      tableOptions: {
        ...
        addButton: {
          ...
          disabled: !this.$store.getters[
            "permissions/getNotificationTemplatesCreatePermissions"
          ],
        },
        savedFiltersLocalStorageKey:
          DEFAULT_SEARCH_CONTAINER_KEYS.NOTIFICATION_TEMPLATE,
        savedTableSettingsLocalStorageKey:
          TABLE_SETTINGS_KEYS.NOTIFICATION_TEMPLATE,
        empty: {
        ...
        rowActions: [
          {
            ...
            action: "handleEdit",
            disabled: !this.$store.getters[
              "permissions/getNotificationTemplatesUpdatePermissions"
            ],
          },
          {
            name: "Duplicate",
          ...
          },
          {
            ...
            action: "handleDelete",
            disabled: !this.$store.getters[
              "permissions/getNotificationTemplatesDeletePermissions"
            ],
          },
          // {
          //   name: "Make Default",
  ...
  methods: {
    ...
    toggleDeleteNotificationTemplate() {
      ...
      this.showDeleteNotificationTemplateModal = !this
        .showDeleteNotificationTemplateModal;
    },
