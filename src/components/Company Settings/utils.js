...
export const MERGED_TEXTS_MAP = {
  ...
  '{ANALYSEDEMAIL}': analysedEmail,
  '{FOUNDEMAILCOUNT}': foundEmailCount,
  '{STARTEDBY}': startedBy,
  '{STARTDATE}': startDate,
  '{INVESTIGATIONNAME}': investigationName,
  '{INVITEDUSERNAME}': invitedUserName,
  '{INVITEDBYCOMPANYNAME}': invitedByCompanyName,
  '{COMMUNITYURL}': communityUrl,
  '{MEMBERCOUNT}': memberCount,
  '{FROMEMAIL}': fromEmail,
  '{FROMNAME}': fromName,
  '{COMMUNITYINDUSTRY}': communityIndustry,
  '{ANALYSISEMAIL}': analysisEmail,
  '{OWNER}': owner,
  '{DATE}': date,
  '{REPORTBY}': reportBy,
  '{FROM}': fromText,
  ...
  '{ANALYSISDETAILURL}': analysisDetailUrl,
  '{INVESTIGATIONURL}': investigationUrl,
  '{COMPANYLOGO}': companyLogo,
  '{TRAININGNAME}': trainingName,
  '{TRAININGDESCRIPTION}': trainingDescription,
  '{TRAININGURL}': trainingUrl,
  '{TRAININGLANGUAGESELECTION}': trainingLanguageSelection,
