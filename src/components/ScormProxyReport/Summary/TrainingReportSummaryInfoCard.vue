<template>
  <CardLoading
    :loading="isLoading"
    :class="[
      'training-report-summary-info-card',
      isLoading && 'training-report-summary-info-card--loading'
    ]"
    :style="{ backgroundColor }"
  >
    <template #skeleton-content>
      <div class="training-report-summary-info-card-body">
        ...
        <div class="training-report-summary-info-card-body__icon">
          <slot name="icon">
...
export default {
  name: 'TrainingReportSummaryInfoCard',
