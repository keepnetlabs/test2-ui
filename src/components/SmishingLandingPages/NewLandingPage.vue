      ...
      <v-stepper
        ...
        <v-stepper-header class="k-stepper__header">
          <v-stepper-step
            ...
            :complete="step > 1"
            :step="1">Template Info</v-stepper-step>
          <v-divider class="k-stepper__divider" />
          <v-stepper-step
            class="k-stepper__step"
            :complete="step > 2"
            :step="2">Page Settings</v-stepper-step>
        </v-stepper-header>
              ...
              <v-list-item>
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle
                    class="new-email-template__sub-title">Enter basic information about this landing page template</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
            ...
            <div class="email-settings">
              <v-list-item>
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle
                    class="new-email-template__sub-title">Enter basic information about this email template</v-list-item-subtitle>
                </v-list-item-content>
              </v-list-item>
                        ...
                        <VTooltip
                          ...
                          <template #activator="{ on }">
                            <v-icon
                              v-on="on"
                              class="ml-2"
                              color="#757575">mdi-information</v-icon>
                          </template>
                          <span>Once enabled, bot activity is automatically detected and stopped to
                            ...
                            <v-menu
                              ...
                              <template v-slot:activator="{ on }">
                                <v-icon
                                  v-ripple="false"
                                  v-on="on"
                                  class="landing-page-tab-content__button">mdi-dots-horizontal</v-icon>
                              </template>
                              <v-list>
                                <v-list-item
                            ...
                            <template v-slot:activator="{ on: menu }">
                              <v-btn
                                ...
                                <v-icon
                                  class="mr-2"
                                  size="18"
                                  color="#2196f3">mdi-plus-circle-outline</v-icon>
                                <span class="landing-page-tab__label">
                                  Add page
                                </span>
                              </v-btn>
      ...
      return {
        ...
        commonRules: {
          ...
          rules: [
            ...
            (v) => Validations.maxLength(v, 256, labels.getMaxLengthMessage(labels.TemplateName,256))
          ]
        },
      ...
      submit() {
        ...
        if (this.$refs.refEmailTemplateContent.validate() && isValid) {
          ...
          if (this.isEdit && !this.isDuplicate) {
            SmishingService.updateLandingPageTemplate(this.emailTemplateId, payload)
              .then(() => {
            ...
            SmishingService.createLandingPageTemplate(payload)
              .then(() => {
                this.$emit('changeNewEmailTemplateModalStatus', false, true)
              })
              .finally(() => {
