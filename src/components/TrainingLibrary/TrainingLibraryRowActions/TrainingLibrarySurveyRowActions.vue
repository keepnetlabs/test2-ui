...
export default {
  name: 'TrainingLibrarySurveyRowActions',
  ...
  data() {
    return {
      rowActions: [
        {
          id: 'btn-preview--row-actions-survey',
          name: labels.Preview,
          icon: 'mdi-eye'
        },
        {
          id: 'btn-send--row-actions-survey',
          name: labels.SendSurvey,
          icon: 'mdi-send'
        },
        {
          id: 'btn-favorite--row-actions-survey',
        ...
        {
          id: 'btn-edit--row-actions-survey',
          name: labels.Edit,
          icon: 'mdi-pencil'
        },
        {
          id: 'btn-duplicate--row-actions-survey',
          name: labels.Duplicate,
          icon: 'mdi-content-copy',
          action: 'on-duplicate'
        },
        {
          id: 'btn-delete--row-actions-survey',
          name: labels.Delete,
          icon: 'mdi-delete'
        }
      ]
