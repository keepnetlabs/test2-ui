  ...
  >
    <template #overlay-header>
      <v-list-item class="k-overlay__list-item k-overlay__header">
        ...
        <v-list-item-content>
          <v-list-item-title class="k-overlay__title">Send Survey</v-list-item-title>
...
export default {
  ...
  data() {
    return {
      ...
      labels,
      stepperIds: {
        cancelButton: 'btn-cancel--send-survey-modal',
        backButton: 'btn-back--send-survey-modal',
        nextButton: 'btn-next--send-survey-modal',
        saveButton: 'btn-save--send-survey-modal'
      },
  ...
  computed: {
    ...
    getTitle() {
      return `Send Survey - ${this?.selectedRow?.surveyName}`
    },
    getSaveButtonText() {
