  ...
  >
    <template #overlay-header>
      <v-list-item class="k-overlay__list-item k-overlay__header">
        ...
        <v-list-item-content>
          <v-list-item-title class="k-overlay__title">Send Learning Path</v-list-item-title>
...
import { emptyLearningPathSendModalObj, getAutoEnrollText } from '@/components/TrainingLibrary/utils'
import {
  endTypeItems,
