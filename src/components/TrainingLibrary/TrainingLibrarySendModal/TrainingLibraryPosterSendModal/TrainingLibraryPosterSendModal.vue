  ...
  >
    <template #overlay-header>
      <v-list-item class="k-overlay__list-item k-overlay__header">
        ...
        <v-list-item-content>
          <v-list-item-title class="k-overlay__title">Send Poster</v-list-item-title>
        ...
        <v-stepper-items class="k-stepper__items">
          ...
          <v-stepper-content class="k-stepper__content" :step="2">
            ...
            <TrainingLibrarySendTrainingSelectUsers
              ...
              :target-users-group-sub="labels.PosterTargetUserGroupsSub"
...
import { emptyPosterSendModalObj, getAutoEnrollText } from '@/components/TrainingLibrary/utils'
...
export default {
  ...
  methods: {
    ...
    handleClose() {
      this.setPosterSendModal(emptyPosterSendModalObj)
    },
