  ...
  >
    <template #overlay-header>
      <v-list-item class="k-overlay__list-item k-overlay__header">
        ...
        <v-list-item-content>
          <v-list-item-title class="k-overlay__title">Send Screensaver</v-list-item-title>
        ...
        <v-stepper-items class="k-stepper__items">
          ...
          <v-stepper-content class="k-stepper__content" :step="2">
            ...
            <TrainingLibrarySendTrainingSelectUsers
              ...
              :target-users-group-sub="labels.ScreensaverTargetUserGroupsSub"
              :campaign-results-sub="labels.ScreensaverCampaignResultsSub"
...
export default {
  ...
  methods: {
    ...
    handleClose() {
      this.setScreensaverSendModal(emptyScreensaverSendModalObj)
    },
