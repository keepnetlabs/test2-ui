        ...
        <v-stepper-items class="k-stepper__items">
          ...
          <v-stepper-content class="k-stepper__content" :step="2">
            ...
            <TrainingLibrarySendTrainingSelectUsers
              ...
              :target-users-group-sub="labels.InfographicTargetUserGroupsSub"
...
import { emptyInfographicSendModalObj, getAutoEnrollText } from '@/components/TrainingLibrary/utils'
import {
...
export default {
  ...
  methods: {
    ...
    handleClose() {
      this.setInfographicSendModal(emptyInfographicSendModalObj)
    },
