  ...
  <v-form ref="refForm" class="send-training-settings">
    ...
    <FormGroup v-if="false" class="mt-6" :title="labels.Reminder" style="max-width: 875px;">
      <div class="campaign-manager-advanced-settings__other-settings-last">
        <v-checkbox
          ...
          id="input--send-infographic-send-reminder"
          color="#2196f3"
          hide-details
        >
        </v-checkbox>
    ...
    >
      <div class="d-flex align-center">
        <v-checkbox
          ...
          id="input--send-infographic-award-certificate"
          hide-details
          color="#2196f3"
    ...
    >
      <div class="campaign-manager-advanced-settings__other-settings-last">
        <v-checkbox
          ...
          id="input--send-infographic-auto-enroll"
          color="#2196f3"
          hide-details
        >
        </v-checkbox>
    ...
    <FormGroup :class="!formData.isProxy ? 'mt-6' : ''" title="Mark as Test">
      <v-checkbox
        ...
        id="input--send-infographic-marked-as-test"
        hide-details
        color="#2196f3"
  ...
  computed: {
    ...
    deliveryMethodText() {
      if (this.formData.deliveryMethod === DELIVERY_METHODS.SMS) {
        return 'Infographic is delivered in SMS and also sent by email.'
      } else if (this.formData.deliveryMethod === DELIVERY_METHODS.MICROSOFT_TEAMS) {
        return 'Infographic is delivered in Microsoft Teams and also sent by email.'
      }
      return ''
    }
  },
