<template>
  <v-form ref="refForm">
    ...
    <InputTrainingLevel
      ...
      :items="getLevels"
      :required="false"
      sub-title="Select the level of knowledge required for this training"
    ...
    <InputTrainingDuration
      ...
      :items="getDurations"
      :required="false"
      sub-title="Select the estimated time it takes to complete the training"
    ...
    <TrainingLibraryCoverImageField
      ...
      :subtitle="labels.UploadCoverImageForTheTraining"
      ...
      try {
        ...
        if (generatedDescription) {
          ...
          this.formData.description = `This ${
            this.selectedCategoryText || "training"
