    ...
    handleGenerate() {
      ...
      setTimeout(() => {
        ...
        this.formData.description =
          'This training course provides comprehensive education on security awareness, covering essential topics such as phishing prevention, password security, and safe browsing practices.'
