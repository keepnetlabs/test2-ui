<template>
  <v-form ref="refForm">
    ...
    <InputTrainingLevel
      ...
      :items="getLevels"
      :required="false"
      sub-title="Select the level of knowledge required for this screensaver"
      placeholder="Select screensaver level"
    />
    <InputTrainingDuration
      v-model="formData.duration"
      :items="getDurations"
      :required="false"
      sub-title="Select the estimated time it takes to review the screensaver"
      placeholder="Select screensaver duration"
    />
    ...
    <InputSelectRoles
      ...
      item-text="text"
      item-value="value"
      sub-title="Select intended role for this screensaver"
    />
    <FormGroup
      :title="labels.Description"
      :sub-title="labels.DescriptionScreensaverSub"
    >
      <InputAIDescription
        ...
        tooltip-message="To generate an AI-powered description, complete key fields like Screensaver Name, Category, and Role."
    ...
    async handleGenerate() {
      ...
      try {
        ...
        if (generatedDescription) {
          ...
          this.formData.description = `This screensaver content is designed for ${
