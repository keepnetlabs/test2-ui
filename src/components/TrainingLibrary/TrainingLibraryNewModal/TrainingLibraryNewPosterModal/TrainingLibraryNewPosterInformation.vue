<template>
  <v-form ref="refForm">
    ...
    <InputTrainingLevel
      ...
      :items="getLevels"
      :required="false"
      sub-title="Select the level of knowledge required for this poster"
      placeholder="Select poster level"
    />
    <InputTrainingDuration
      v-model="formData.duration"
      :items="getDurations"
      :required="false"
      sub-title="Select the estimated time it takes to review the poster"
      placeholder="Select poster duration"
    />
    ...
    <InputSelectRoles
      ...
      item-text="text"
      item-value="value"
      sub-title="Select intended role for this poster"
    />
    <FormGroup
      has-hint
      :title="labels.Description"
      :sub-title="labels.DescriptionPosterSub"
    >
      <InputAIDescription
        ...
        tooltip-message="To generate an AI-powered description, complete key fields like Poster Name, Category, and Role."
    ...
    <FormGroup
      ...
      :sub-title="labels.UploadCoverImageForThePoster"
    >
      <KFileUpload
    ...
    async handleGenerate() {
      ...
      try {
        ...
        if (generatedDescription) {
          ...
          this.formData.description = `This poster content is designed for ${
