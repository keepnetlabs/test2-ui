<template>
  <div>
    <FormGroup
      v-if="canSaveVendor"
      has-hint
      :title="labels.PosterVendor"
      :sub-title="labels.PosterVendorSub"
    >
      <KSelect
        ...
        item-value="value"
        hint="*Required"
        placeholder="Select poster vendor"
...
export default {
  name: 'TrainingLibraryNewPosterContent',
  components: { NewPosterContentByLanguage, FormGroup, KSelect, AlertBox },
  props: {
