  ...
  >
    ...
    <template #overlay-footer>
      <StepperFooter
        max-step="2"
        :ids="{
          cancelButton: 'btn-cancel--add-or-edit-survey-modal',
          backButton: 'btn-back--add-or-edit-survey-modal',
          nextButton: 'btn-next--add-or-edit-survey-modal',
          saveButton: 'btn-save--add-or-edit-survey-modal'
        }"
        :step="step"
        :disabled-statuses="{
