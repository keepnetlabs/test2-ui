  ...
  <div>
    <ElTabs v-model="tab">
      ...
      <ElTabPane
        ...
        name="details"
        id="campaign-manager-info--training-details-content-survey"
      >
        <template v-if="trainingParams">
          ...
          <div class="training-library-preview__details-item align-baseline">
            ...
            <div class="d-flex flex-wrap gap-2 ml-2">
              <span
                v-for="(tag, tIndex) in trainingParams.tagNames"
                :key="tIndex"
                class="training-library-preview__tag"
                >{{ tag }}</span
              >
          ...
          <div class="training-library-preview__details-item">
            ...
            <ul>
              <li
                v-for="(behaviour, bIndex) in trainingParams.behaviourNames"
                :key="bIndex"
...
export default {
  name: 'TrainingLibrarySurveyPreview',
  components: {
    TrainingLibraryFavoriteButton,
