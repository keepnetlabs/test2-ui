    ...
    <v-tooltip bottom>
      <template #activator="{ on }">
        <v-btn
          v-on="on"
          :id="getId"
          :disabled="!getSmishingCampaignManagerPreviewPermissions"
          class="btn-hover"
          icon
...
export default {
  ...
  computed: {
    ...mapGetters({
      getSmishingCampaignManagerPreviewPermissions:
        'permissions/getSmishingCampaignManagerPreviewPermissions',
      getSmishingCampaignManagerCreatePermissions:
        'permissions/getSmishingCampaignManagerCreatePermissions',
      getSmishingCampaignManagerDeletePermissions:
        'permissions/getSmishingCampaignManagerDeletePermissions',
      getSmishingCampaignManagerEditPermissions:
        'permissions/getSmishingCampaignManagerEditPermissions'
    }),
    getId() {
    ...
    getItems() {
      ...
      const newInstanceItem = {
        ...
        action: 'on-launch',
        disabled: !this.getSmishingCampaignManagerCreatePermissions
      }
      const duplicateItem = {
      ...
      const deleteItem = {
        ...
        icon: 'mdi-delete',
        action: 'on-delete',
        disabled: !this.getSmishingCampaignManagerDeletePermissions
      }
      const editItem = {
        name: labels.Edit,
        isNotShow: true,
        ...
        icon: 'mdi-pencil',
        action: 'on-edit',
        disabled: !this.getSmishingCampaignManagerEditPermissions || this.scope.row.frequency > 0
      }
