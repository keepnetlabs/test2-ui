<template>
  <div v-if="isVisible">
    ...
    <VNavigationDrawer
      ...
      height="100%"
    >
      <div class="sovereignty-report-drawer__header--sticky">
        <div class="sovereignty-report-drawer__header k-navigation-drawer__header">
          <div>
            <VListItem>
              <VListItemContent>
      ...
      <div class="sovereignty-report-drawer__body k-navigation-drawer__body">
        <template v-if="loading">
          <VSkeletonLoader type="article, paragraph, list-item-three-line, paragraph" />
        </template>
        ...
        <template v-else-if="report">
          <AlertBox
            ...
            :class="verdictTone === 'pass' ? 'bg-green-light' : 'bg-red-light'"
            :icon-color="verdictTone === 'pass' ? '#43a047' : '#f56c6c'"
            :icon-name="verdictTone === 'pass' ? 'mdi-check-circle' : 'mdi-alert-circle'"
            :slots="{ primaryAction: false, secondaryAction: false }"
          >
            <template #text>
          ...
          <section v-if="validationRules.length" class="sovereignty-report-drawer__section">
            ...
            <ul class="sovereignty-report-drawer__rules">
              <li
                ...
                :class="`sovereignty-report-drawer__rule--${(rule.outcome || 'unknown').toLowerCase()}`"
              >
                ...
                <p class="sovereignty-report-drawer__rule-desc">{{ rule.description }}</p>
          ...
          <section v-if="auditConclusion" class="sovereignty-report-drawer__section">
            ...
            <div class="sovereignty-report-drawer__conclusion-card">
              ...
              <p v-if="auditConclusion.statement" class="sovereignty-report-drawer__conclusion-text">
...
export default {
  ...
  computed: {
    ...
    databaseChecks() {
      return Array.isArray(this.report?.databaseChecks) ? this.report.databaseChecks : []
    },
    violations() {
  ...
  methods: {
    ...
    humanizeRole(role) {
      ...
      if (role === 'expected-region') return 'Expected region'
