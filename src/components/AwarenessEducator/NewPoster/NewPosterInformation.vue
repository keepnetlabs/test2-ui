  ...
  <v-form ref="refForm">
    ...
    <FormGroup
      ...
      <KSelect
        ...
        :items="categories"></KSelect>
    </FormGroup>
    <FormGroup
      has-hint
      :title="labels.TargetAudience"
      :sub-title="labels.TargetAudiencePosterSub">
      <KSelect
        ...
        :rules="[(v) => Validations.required(v, labels.Required)]"
        :items="targetAudiences"></KSelect>
    </FormGroup>
    <FormGroup
      :title="labels.Tags"
      :sub-title="labels.TagPosterSub">
      <InputTag
