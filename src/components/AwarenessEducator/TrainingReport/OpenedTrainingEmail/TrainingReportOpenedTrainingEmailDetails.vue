<template>
  <AppDialog
    title-id="text--training-report-opened-training-email-details-popup-title"
    subtitle-id="text--training-report-opened-training-email-details-popup-subtitle"
    maxHeightSize="665"
    :custom-size="'1000'"
    :icon="CONSTANTS.icon"
    title="Details"
...
export default {
  name: 'TrainingReportOpenedTrainingEmailDetails',
  ...
  data() {
    return {
      CONSTANTS: {
        icon: 'mdi-text-box',
        id: 'training-report-opened-training-email-details-item-data-table',
        ascending: 'ascending'
      },
      serverSideProps: new ServerSideProps(),
      axiosPayload: getDefaultAxiosPayload({ orderBy: 'DateOpened' }),
      tableOptions: {
      ...
      tableData: [
        {
          dateOpened: '31.05.2021 16:43:12',
          userAgent:
