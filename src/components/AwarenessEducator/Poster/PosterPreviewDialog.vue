  ...
  <AppDialog
    ...
    <template #app-dialog-body>
      <DatatableLoading
        ...
        :loading="isLoading" />
      <ElTabs
        v-if="!isLoading && showTabs"
        v-model="tab">
        <ElTabPane
          id="poster-info--preview-content"
          name="preview"
          ...
          <div class="training-library-preview__details-item align-baseline">
            ...
            <div class="d-flex flex-wrap gap-2">
              <span
                ...
                :key="tag"
                class="training-library-preview__tag">{{ tag }}</span>
            </div>
          </div>
        </ElTabPane>
      </ElTabs>
      <div
        ...
        <div class="template-preview__text">
          ...
          <FormGroupHorizontalContent
            class="poster-preview-specification"
            label="Specifications:">
            <KSelect
              v-model="specification"
              dense
