<template>
  <v-form
    ref="refForm"
    class="send-training-settings">
    <FormGroup
      has-hint
      :title="labels.EnrollmentName">
      <InputEntityName
    ...
    <FormGroup
      ...
      <div class="send-training-settings__lms-helper">
        ...
        <span
          class="text-primary-color fs-3 ml-2">When the Training Delivery for Your LMS is activated, only the Content Language and Mark
    ...
    <FormGroup
      ...
      <v-radio-group
        ...
        <div class="campaign-manager-advanced-settings__distribution-item mt-n2">
          ...
          <span
            class="v-label theme--light mx-2"
            style="font-size: 14px;">on</span>
          <InputTimezone
