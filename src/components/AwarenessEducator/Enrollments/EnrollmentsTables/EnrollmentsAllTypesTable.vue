...
export default {
  ...
  data() {
    return {
      ...
      tableOptions: {
        savedFiltersLocalStorageKey: DEFAULT_SEARCH_CONTAINER_KEYS.ENROLLMENTS_ALL_TYPES_LIST,
        savedTableSettingsLocalStorageKey: TABLE_SETTINGS_KEYS.ENROLLMENTS_ALL_TYPES_LIST,
        selectEvent: {
          clipboard: true,
          edit: false,
          delete: false,
