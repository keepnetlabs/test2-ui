...
export default {
  ...
  data() {
    return {
      ...
      axiosPayload: getDefaultAxiosPayload({
        enrollmentType: TRAINING_LIBRARY_PAYLOAD_TYPES.POSTER
      }),
      tableData: [],
      ...
      tableOptions: {
        ...
        iEmpty: {
          message: labels.EmptyEnrollmentPoster
        },
        addButton: {
          show: false
        },
  ...
  computed: {
    ...
    savedFiltersKey() {
      return this.isTrash
        ? DEFAULT_SEARCH_CONTAINER_KEYS.TRASH_POSTER_LIST
        : DEFAULT_SEARCH_CONTAINER_KEYS.ENROLLMENTS_POSTER_LIST
    },
    savedTableSettingsKey() {
      return this.isTrash
        ? TABLE_SETTINGS_KEYS.TRASH_POSTER_LIST
        : TABLE_SETTINGS_KEYS.ENROLLMENTS_POSTER_LIST
    }
  },
  methods: {
    callForData() {
