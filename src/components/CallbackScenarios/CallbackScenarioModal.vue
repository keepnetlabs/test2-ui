      ...
      <v-stepper
        ...
        <v-stepper-header class="k-stepper__header">
          ...
          <v-stepper-step
            class="k-stepper__step"
            :complete="step > 2"
            :step="2">Email Template</v-stepper-step>
          <v-divider class="k-stepper__divider" />
          ...
          <v-stepper-step
            ...
            :complete="step > 3"
            :step="3">Callback Template</v-stepper-step>
          <v-divider class="k-stepper__divider" />
          <v-stepper-step
            class="k-stepper__step"
            :complete="step > 4"
            :step="4">Summary</v-stepper-step>
        </v-stepper-header>
          ...
          <v-stepper-content
            ...
            <div class="phishing-scenario-info">
              ...
              <v-form
                ...
                <form-group
                  title="Description"
                  sub-title="Describe the scenario briefly">
                  <InputDescription
                    ...
                    <div class="summary-header">
                      ...
                      <div>
                        <v-btn
                          ...
                          outlined
                          color="#2196f3"
                          @click="showTemplate1 = !showTemplate1">Preview
                          <v-icon
                            :color="'#2196f3'"
                            class="ml-2"
                            left
