export const labels = {
  ...
  EmptyTrainingReportTrainingSurveys: 'Everyone has interacted with the survey email',
  ...
  EmptyTrainingReportProgressSurvey: 'You do not have any users enrolled for this survey',
