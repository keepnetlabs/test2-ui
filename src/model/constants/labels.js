export const labels = {
  ...
  EmptyTrainingReportNoResponseSurvey: 'Everyone has interacted with the survey email',
  EmptyTrainingReportSurveyUsers: 'No one has taken the survey, yet',
  ...
  PosterVendor: 'Poster Vendor',
  PosterVendorSub: 'Define vendor for the poster',
  InfographicVendor: 'Infographic Vendor',
  InfographicVendorSub: 'Define vendor for the infographic',
  ScreensaverVendor: 'Screensaver Vendor',
  ScreensaverVendorSub: 'Define vendor for the screensaver',
  ...
  ScenariosOfInstance: 'Scenarios Of Run',
  ...
  Later: 'Later',
  Training: 'Training',
  RecurrencesOfInstance: 'Recurrences Of Run',
  ...
  EmptyTrainingReportClickedSurvey: 'No one has clicked the survey link, yet',
  ...
  EmptyTrainingReportSurveyProgress: 'No one has survey progress, yet',
  ...
  ExcludedIPTooltipText:
    'This IP address is excluded by system to prevent false positive reporting.',
  ...
  SurveyCampaignResultsSub: 'Select the campaign results below to send the survey',
  SurveyTargetUserGroupsSub: 'Select user groups below to send the survey',
  NotDelivered: 'Not Delivered',
  UserWhoSubmittedData: 'Users who submitted data',
  UserWhoSubmittedMFACode: 'Users who submitted MFA code',
  SelectInstance: 'Select Run',
  ...
  EmptySurvey: 'You do not have any survey',
  ...
  SendSurveyTargetUsersSub: 'Select users you want to send this survey',
  ...
  SurveyContentUploadSub: 'Upload survey content by language',
  ...
  EmptyTrainingReportOpenedSurvey: 'No one has opened the survey email, yet',
  EmptyTrainingReportSurveyNonUsers: 'No one has taken the survey, yet',
  ...
  ClickedSurveyLink: 'Clicked Survey Link',
  CreateNewSurvey: 'Create New Survey',
  EditSurvey: 'Edit Survey',
  SurveyContent: 'Survey Content',
  OpenedSurveyEmail: 'Opened Survey Email',
  OpenededSurvey: 'Opened Survey',
  DownloadedSurvey: 'Downloaded Survey',
  ...
  SurveyContentSub: 'Select properties and set your survey',
  ...
  Phishing: 'Phishing',
  CreateNewInstance: 'Create new run',
  CampaignInstance: 'Campaign Run',
  CampaignInstanceSub:
    'Select target groups and schedule options for this phishing campaign run',
  QuishingCampaignInstanceSub:
    'Select target groups and schedule options for this quishing campaign run',
  ...
  InstancesOfCampaign: 'Runs Of Campaign',
  Start: 'Start',
  Stop: 'Stop',
  Paused: 'Paused',
  Cancelled: 'Cancelled',
  ...
  SurveySummarySub: 'Summary of this survey enrollment',
  ResendSurvey: 'Resend Survey',
  CompletedSurvey: 'Completed Survey',
  SurveyEnrollmentInfo: 'Survey Enrollment Info',
  SurveyDelivery: 'Survey Delivery',
