<template>
  <div id="community-page-wrapper" class="page-wrapper">
    ...
    <v-overlay
      ...
      :z-index="999"
    >
      <v-card id="notification-card" light class="confirm-dialog pb-4 pa-6" style="width: 370px;">
        ...
        <v-list-item id="notification-dashboard-wrapper" class="community-notification-row pa-0">
        ...
        <v-list-item id="notification-whatsapp-wrapper" class="community-notification-row pa-0">
          SMS notifications
          <v-switch
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      if (encodeURI(this.selectedCommunity.name) != window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1)) {
        this.$router.push('/threat-sharing')
      }
