<template>
  ...
  <div id="phishing-reporter" class="investigation-details">
        ...
        <div class="investigation-details__container__stats__cards">
          <div class="investigation-details__container__stats__cards__card">
            <div class="investigation-details__container__stats__cards__card-left">
              ...
              >
                <v-icon medium left color="white">mdi-puzzle</v-icon>
              </div>
            </div>
            <div class="investigation-details__container__stats__cards__card-right">
              <h3
        ...
        <div class="investigation-details__container__stats__cards">
          <div class="investigation-details__container__stats__cards__card">
            <div class="investigation-details__container__stats__cards__card-left">
              ...
              >
                <v-icon medium left color="white">mdi-account-outline</v-icon>
              </div>
            </div>
            <div class="investigation-details__container__stats__cards__card-right">
              <h3
        ...
        <v-col class="pl-0 phishing-reporter__tab-container" cols="12">
          <v-card id="pr-card" class="pr-card">
            <v-tabs id="pr-tabs" v-model="tab" background-color="transparent" color="basil"
              ...
              <v-tab id="pr-tab-settings" class="pr-tab p-2" @click="changeTabStatus(1)">Settings
              </v-tab>
            </v-tabs>
