      ...
      <div class="investigation-details__container">
        ...
        >
          <template v-slot:app-dialog-body>
            <v-list-item
              class="check-wrapper investigation-details__alerts-content pl-0 pr-0"
            >
              <v-form
                class="w-100"
                lazy-validation
                  ...
                  >
                    ...
                    >
                      ...
                      <p class="tooltip-wrapper">
                        ...
                        depended on conditions such as online user count, mailbox size,
                        etc.
                      </p>
                    </v-tooltip>
                ...
                <div class="investigation-details__container__stats__cards__card-right">
                  ...
                  >
                    {{
                      getStatusText(
                        "scannedEmailCount",
                        statsAndMenuData.scannedEmailCount
                      )
                    }}
                  </h3>
                  <p
        ...
        <div
          class="investigation-details__container__content card v-card v-sheet theme--light"
        >
            ...
            <InvestigationDetailsLeftBarLoading :loading="leftMenuLoading">
              <template v-slot:skeleton-content>
                <div class="investigation-details__container__content--left-menu--time">
                  ...
                  <div
                    class="investigation-details__container__content--left-menu--time--progress"
                  >
                ...
                <div
                  class="investigation-details__container__content--left-menu--mail-menu"
                >
                  <v-card>
                    <v-navigation-drawer permanent>
                      <v-list dense nav>
                        ...
                        >
                          <v-list-item-icon>
                            <v-icon medium left color="#909399"
                          ...
                          <v-list-item-content>
                            <v-list-item-title>
                              ...
                              <span
                                ...
                                v-if="
                                  statsAndMenuData && statsAndMenuData.scannedUserCount
                                "
          ...
          <div class="investigation-details__container__content--right-menu">
            <ThreeRowLoading :loading="contentMenuLoading">
              <template v-slot:skeleton-content>
                <div
                  class="investigation-details__container__content--right-menu__summary"
                >
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <v-list>
                          <v-list-item
                            id="btn-auto-refresh--investigation"
                ...
                >
                  ...
                  <show-more
                    :data="criteriaChips"
                    btn-show-more-id="btn-show-more--criteria"
                  />
                </div>
              </template>
            </ThreeRowLoading>
              ...
              >
                <template #datatable-row-actions="{ scope }">
                  ...
                  <DefaultButtonRowAction
                    ...
                    :scope="scope"
                    :disabled="
                      rowActions[1].disabled || getWarningEmailDisableStatus(scope.row)
                    "
                  ...
                  <template v-if="scope.row.emailLastAction">
                    <span class="d-flex align-center">
                      <span class="ml-2">
                        <v-tooltip
                          v-if="
                            getActionStatusOptions(scope.row.emailLastAction).isTooltip
                          "
                          bottom
                          max-width="250"
                        ...
                        >
                          <template v-slot:activator="{ on }">
                            <div class="d-flex" v-on="on">
                              <v-icon
                                ...
                                class="mr-1"
                                :color="
                                  getActionStatusOptions(scope.row.emailLastAction).color
                                "
                                >{{
                                  getActionStatusOptions(scope.row.emailLastAction).icon
                                }}</v-icon
                          ...
                          <span
                            >{{
                              getActionStatusOptions(scope.row.emailLastAction)
                                .tooltipText
                            }}
                          </span>
                        </v-tooltip>
            ...
            >
              <datatable
                ...
                @refreshAction="refreshDatatable"
                @server-side-page-number-changed="
                  serverSidePageNumberChangedForTargetUsers
                "
              ...
              >
                <template v-slot:datatable-custom-column="{ scope }">
                  <div class="datatable-progress">
                    <template
                      v-if="scope.row && parseInt(scope.row.analyzedMailCount) >= 0"
                    >
                      <span
                        :class="[
                          Math.floor(
                      ...
                      <span class="datatable-progress__stats">
                        {{
                          scope.row.analyzedMailCount +
                          " / " +
                          scope.row.filteredMailCount
                        }}
                        mails
                      </span>
                    </template>
...
import {
  exportInvestigationEmailList,
  exportInvestigationUserList,
  ...
  methods: {
    getLeftMenuItemClasses(item) {
      return {
        ...
        "v-list-item-title__value--orange":
          this.activeMenu !== item && this.itemStats[item].notify,
      };
    },
    setAutoRefresh() {
    ...
    handleClearFilters(isAutoTrue) {
      ...
      this.investigationListBodyData = JSON.parse(
        JSON.stringify(this.defaultRequestBody)
      );
    ...
    getProgressText(scope) {
      if (scope.row.status === "Completed" || scope.row.progress === 100)
        return "Completed";
    ...
    getProgressValue(scope) {
      ...
      return Math.floor(
        (scope.row.analyzedMailCount / scope.row.filteredMailCount) * 100
      );
    },
    ...
    calculateProgressData() {
      if (
        ...
        !Object.keys(this.investigationDetailsData).length
      )
        return;
    ...
    iconType() {
      ...
      else if (this.statsAndMenuData.status === "Canceled")
    ...
    sendInvestigationDetailsWarningMessage(
      ...
      if (
        value &&
        value.emailLastAction &&
        value.emailLastAction.actionType === "Warning"
      ) {
    ...
    deleteAndNotifyInvestigationDetailsFunction(value) {
      if (
        value &&
        value.emailLastAction &&
        value.emailLastAction.actionType === "Delete"
      ) {
  ...
  computed: {
    ...
    itemStats() {
      return {
        ...
        JunkEmail: {
          count:
            this.statsAndMenuData?.folders?.find(
    ...
    getTimeLeftText() {
      ...
      if (this.loading) return "Loading...";
        ...
        return `${
          diffDays > 0 ? diffDaysText : ""
        }${totalHoursText}${totalMinutes} minute(s) left`;
    },
  ...
  watch: {
    ...
    investigationDetailsData(val) {
      ...
      const headers = JSON.parse(
        JSON.stringify(this?.investigationDetailsData?.headers || [])
      );
